CREATE
OR REPLACE VIEW public.core_capacity_funders_by_category AS WITH top_level_stakeholder_ids AS (
    SELECT
    ...
    WHERE
        NOT (
            children_to_parents_direct_credit.parent_id IN (
                SELECT
...
SELECT
    ...
    round(
        ...
        2
    ) AS "Percentage of disbursements for this Core capacity"
FROM
    results